      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?php echo site_url('page') ?>">Buku Tamu</a>
          </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="<?php echo site_url('admin') ?>"><i class="fas fa-th-large"></i> <span>Data Toko</span></a></li>
            <li><a class="nav-link" href="<?php echo site_url('admin/tamu') ?>"><i class="fas fa-users"></i> <span>Data Tamu</span></a></li>
