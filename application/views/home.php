<!DOCTYPE html>
  ...
  <section class="abovefold pt-md-5">
    ...
    <div class="container header">
        <div class="row">
            <div class="col-md-6 px-md-0 my-auto">
                <div class="headline">
                    Toko <span class="cl-light-blue">Riska</span>
                </div>
                <div class="sub-headline">
                <?php echo htmlentities($row->daftar_isi_toko, ENT_QUOTES, 'UTF-8');?>
                </div>
                <div class="row four-point sub-headline sub-headline_1">
                    <div class="col-md-6">
                      <img src="<?php echo base_url() ?>assets/page/clock.png" width="18px" alt="">
                      Jadwal Buka :<br>
                      <p class="mt-3">               
                        <?php echo htmlentities($row->jadwal_buka_tutup, ENT_QUOTES, 'UTF-8');?>
                      </p>
                    </div>
                </div>
            </div>
                    ...
                    <form action="<?php echo base_url() ?>page/tambah" method="post">
                      <div class="input-group mb-4">
                        <label for="input" class="w-100">
                            ...
                            <input type="text" class="form-control mt-2" name="nama" placeholder="Nama Kamu" required>
                        </label>
                    </div>
                    <div class="input-group mb-4">
                        <label for="input" class="w-100">
                            <span class="input-title">No.HP</span>
                            <input type="text" class="form-control mt-2" name="hp" placeholder="No.HP Aktif" required>
                        </label>
                    </div>
                    <div class="input-group mb-4">
                        <label for="input" class="w-100">
                            <span class="input-title">Alamat</span>
                            <input type="text" class="form-control mt-2" name="alamat" placeholder="Alamat Kamu" required>
                        </label>
                    </div>
                    <div class="input-group">
                      <label for="input" class="w-100">
                          <span class="input-title">Pesan</span>
                          <textarea class="form-control mt-2" id="exampleFormControlTextarea1" name="pesan" placeholder="Tulis apa aja..." rows="5" required></textarea>
                      </label>
                  </div>
                    <button type="submit" class="btn btn-card w-100">
                        Kirim
                    </button>
                    </form>
                </div>
    ...
    <div class="content-2-2 container-xxl mx-auto p-0  position-relative" style="font-family: 'Poppins', sans-serif">
      <div class="text-center title-text">
        <h1 class="text-title">Buku Tamu</h1>
        <p class="text-caption" style="margin-left: 3rem; margin-right: 3rem">
          Dengar Apa Kata Mereka Tentang Toko Riska
        </p>
      </div>
      ...
      <div class="card-block">
        ...
        <div class="card mb-5">
          <div class="d-flex flex-lg-row flex-column align-items-center">
            <div class="me-lg-3">
              <img
                src="<?php echo base_url() ?>assets/page/man.png" width="150" alt="" />
            </div>
            <div class="flex-grow-1 text-lg-start card-text">
              <h3 class="card-title">
              <?php echo htmlentities($data->nama_tamu, ENT_QUOTES, 'UTF-8');?>
              </h3>
              <p class="card-caption">
              <?php echo htmlentities($data->tujuan_tamu, ENT_QUOTES, 'UTF-8');?>
              </p>
            </div>
          </div>
        </div>
  ...
  </section><section class="h-100 w-100 bg-white mt-5" style="box-sizing: border-box">
		<div class="footer-2-2  mx-auto position-relative p-0" style="font-family: 'Poppins', sans-serif">
			
      
			<div class="border-color info-footer ">
        <hr class="hr" />
				<div class=" container-xxl mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4 justify-content-between">
          <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
            <p style="margin: 0">Copyright © 2021. Riska Safitri</p>
          </nav>
